...
import 'dart:math';
import 'dart:ui';
import 'package:lab9_clima/component/settings.dart';
import 'package:flutter/material.dart';
import 'package:flutter/src/widgets/framework.dart';
import 'package:flutter/src/widgets/placeholder.dart';
import 'package:flutter/widgets.dart';
import 'package:lab9_clima/service/weather.dart';
import 'package:lottie/lottie.dart';
import 'weather.dart';
import 'package:google_nav_bar/google_nav_bar.dart';
import 'package:lab9_clima/component/home.dart';
import 'package:intl/intl.dart';
import 'package:flutter_animate/flutter_animate.dart';
import 'package:free_place_search/core/api.dart';
import 'package:free_place_search/models/address.dart';
import 'package:lab9_clima/component/custom_autoc.dart';
    ...
    return Scaffold(
      ...
      body:
          [
            ...
            SafeArea(child: Column(children: [Expanded(child: settings())])),
          ][_select],
    );
  }
        ...
        Expanded(
          child: Column(
            children: [
              Expanded(
                child: Center(
                  child: Container(
                    child:
                        Text(
                          data[1][temp_index.toInt()][3].toString() + " C",
                          style: TextStyle(
                            fontFamily: "Poppins",
                            fontSize: 100,
              ...
              Container(child: LottieBuilder.asset(_Dicon)),
              Container(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
